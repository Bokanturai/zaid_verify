...
class BVNmodController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.bvn.bvnmod', compact('enrollments', 'search', 'statusFilter', 'bankFilter', 'statusCounts', 'banks'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.bvn.bvnmod-view', compact('enrollmentInfo', 'statusHistory', 'user'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('admin.bvnmod.index')
