            ...
            <div class="col-lg-5 mb-5 mb-lg-0" data-aos="fade-right">
                <div class="support-info-card"
                    ...
                    <div class="d-flex align-items-center mb-4">
                        <div
                            style="width: 50px; height: 50px; background: rgba(255,255,255,0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 20px;">
                ...
                <div class="support-form-wrapper"
                    ...
                    <form id="contact-support-form" action="#" method="POST">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control-custom" placeholder="John Doe"
                                        required>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="subject" class="form-control-custom" placeholder="How can we help?"
                                required>
                        </div>
                        <div class="form-group mb-4">
                            <label style="font-weight: 600; color: #555; margin-bottom: 8px;">Message</label>
                            <textarea name="message" rows="5" class="form-control-custom"
                                placeholder="Describe your issue..." required></textarea>
                        </div>
                        <button type="submit" class="btn btn-primary-custom">Send Message <i
