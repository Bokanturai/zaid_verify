<x-app-layout>
 <title>Zaid verify - NIN Personalisation</title>
      <div class="page-body">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 1.25rem;">
                <div class="card-body p-4 bg-white">
                    <form method="GET" action="{{ route('admin.nin-personalisation.index') }}">
                            ...
                            <div class="col-lg-4">
                                <div class="d-flex gap-2">
                                    ...
                                    @if(request('status') || request('search') || request('bank'))
                                        <a href="{{ route('admin.nin-personalisation.index') }}" class="btn btn-outline-danger px-4 py-2 d-flex align-items-center justify-content-center">
    ...
    <div class="card border-0 shadow-sm" style="border-radius: 1.25rem;">
        <div class="card-header bg-white py-4 border-bottom-0 d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-3">
                    <div class="dropdown">
                        <button class="btn btn-outline-primary btn-sm dropdown-toggle px-3 py-2 d-flex align-items-center shadow-sm" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="ti ti-download me-2"></i> Export
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                            <li><a class="dropdown-item py-2" href="{{ route('admin.nin-personalisation.export-csv') }}"><i class="ti ti-file-text me-2 text-primary"></i>Export as CSV</a></li>
                            <li><a class="dropdown-item py-2" href="{{ route('admin.nin-personalisation.export-excel') }}"><i class="ti ti-file-spreadsheet me-2 text-success"></i>Export as Excel</a></li>
                        </ul>
                    </div>
                        ...
                        @forelse ($enrollments as $enrollment)
                            <tr>
                                ...
                                <td class="pe-4 text-end">
                                    <a href="{{ route('admin.nin-personalisation.show', $enrollment->id) }}" class="btn btn-icon btn-light btn-sm rounded-circle shadow-sm" data-bs-toggle="tooltip" title="View Details">
                                ...
                                <td colspan="7" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        @if(request('search') || request('status'))
                                            <a href="{{ route('admin.nin-personalisation.index') }}" class="btn btn-link btn-sm mt-2">Clear all filters</a>
                                        @endif
                                    </div>
                                </td>
                            </tr>
