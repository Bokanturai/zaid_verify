                            ...
                            <div class="row g-3 align-items-center">
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="search" class="form-control border-start-0 bg-light py-2" placeholder="Search Ticket ID, Batch ID, Agent, Ref..." value="{{ request('search') }}">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="input-group">
                                ...
                                <div class="col-lg-3">
                                    <div class="d-flex gap-2">
                                        ...
                                        @if(request('status') || request('search'))
                                            <a href="{{ route('admin.crm.index') }}" class="btn btn-outline-danger px-4 py-2 d-flex align-items-center justify-content-center">
                ...
                <div class="d-flex align-items-center gap-3">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                            <li><a class="dropdown-item py-2" href="{{ route('admin.crm.export-csv') }}"><i class="ti ti-file-text me-2 text-primary"></i>Export as CSV</a></li>
                            <li><a class="dropdown-item py-2" href="{{ route('admin.crm.export-excel') }}"><i class="ti ti-file-spreadsheet me-2 text-success"></i>Export as Excel</a></li>
                        </ul>
                    </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        <thead class="bg-light text-muted small text-uppercase fw-bold">
                            <tr>
                                ...
                                <th class="py-3">Ticket / Batch ID</th>
                        ...
                        <tbody>
                            @forelse ($enrollments as $enrollment)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm bg-info-subtle text-info rounded-circle me-3">
                                                <i class="ti ti-ticket fs-16"></i>
                                            </div>
                                            <div class="d-flex flex-column">
                                                <span class="fw-bold text-dark">{{ $enrollment->bank ?? $enrollment->ticket_id }}</span>
                                                <small class="text-muted">{{ $enrollment->service_field_name ?? $enrollment->batch_id }}</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-5">
                                        <div class="py-4">
                                            ...
                                            <h6 class="text-muted fw-normal">No CRM records found.</h6>
                                            @if(request('search') || request('status'))
                                                <a href="{{ route('admin.crm.index') }}" class="btn btn-link btn-sm mt-2">Clear all filters</a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
