<x-app-layout>
    <title>Zaid verify - NIN - Suspension</title>
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6 col-12">
                        <h3 class="fw-bold text-dark">Suspension NIN Requests</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 1.25rem;">
                    <div class="card-body p-4 bg-white">
                        <form method="GET" action="{{ route('admin.suspension.index') }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="search" class="form-control border-start-0 bg-light py-2" 
                                               placeholder="Search NIN, Reference, Agent..." value="{{ request('search') }}">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="input-group">
                                ...
                                <div class="col-lg-3">
                                    <div class="d-flex gap-2">
                                        ...
                                        @if(request('status') || request('search'))
                                            <a href="{{ route('admin.suspension.index') }}" class="btn btn-outline-danger px-4 py-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <span class="fw-bold text-dark d-block">{{ $enrollment->nin }}</span>
                                                <small class="text-muted">{{ $enrollment->first_name }} {{ $enrollment->last_name }}</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span class="text-dark fw-medium small">{{ $enrollment->created_at->format('M j, Y') }}</span>
                                            <small class="text-muted">{{ $enrollment->created_at->format('g:i A') }}</small>
                                        </div>
                                    </td>
                                    <td class="pe-4 text-end">
                                        <a href="{{ route('admin.suspension.show', $enrollment->id) }}" class="btn btn-icon btn-light btn-sm rounded-circle shadow-sm" title="View Details">
